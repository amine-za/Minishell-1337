...
SRCS    =	./execution/minishell.c ./execution/builtins.c ./execution/redirections.c ./execution/pipes.c \
			...
			./execution/utils3.c ./execution/pipes_utils.c ./execution/pipes_utils2.c ./parsing/utils.c \
			./parsing/parsing.c ./parsing/utils.c ./parsing/new_beginning.c ./parsing/expanding.c \
